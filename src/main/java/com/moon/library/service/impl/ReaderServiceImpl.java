...
import com.moon.library.dao.ReaderMapper;
import com.moon.library.pojo.Reader;
import com.moon.library.service.ReaderService;
...
public class ReaderServiceImpl implements ReaderService {
    ...
    public PageBean<Reader> listReader(Map<String, Object> paramMap) {
        PageBean<Reader> pageBean = new PageBean<>((Integer) paramMap.get("pageno"), (Integer) paramMap.get("pagesize"));
